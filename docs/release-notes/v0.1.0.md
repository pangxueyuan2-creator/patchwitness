...
- **Real risk demo:** a correct, test-passing feature is blocked because the agent also makes CI
...
- 28 automated tests, including an end-to-end reproduction of the public risk demo.
